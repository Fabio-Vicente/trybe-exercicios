const order = {
  ...
  const orderModifier = order => `Olá ${order.name}, o total do seu pedido de ${Object.keys(order.order.pizza)[0]}, ${Object.keys(order.order.pizza)[1]}, e ${order.order.drinks.coke.type} é R$ ${order.payment.total},00`
